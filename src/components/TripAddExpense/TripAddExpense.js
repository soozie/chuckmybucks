...
class TripAddExpense extends Component {
  constructor(props) {
    super(props);
    this.state = {
      userName: '',
  ...
  render() {
    ...
    return (
      <div className="TripAddExpense">
        <Paper className={classes.root} elevation={1}>
            <FormControl className={classes.formControl} margin="normal">
              <InputLabel htmlFor="user-simple">Name</InputLabel>
              <Select
            ...
            <TextField
              ...
              onChange={(e) => {this.setValue('totalAmount', e.target.value);}}
              margin="normal"
            />
            <TextField
              id="paid-amount"
              ...
              onChange={(e) => {this.setValue('paidAmount', e.target.value);}}
              margin="normal"
            />
            <TextField
              id="date"
...
TripAddExpense.propTypes = {
  classes: PropTypes.object.isRequired,
}

export default withStyles(styles)(TripAddExpense);
